...
export default function LiveRiderStopsTracker({
  ...
  // If driver has already checked off the user's stop
  if (completedStops.includes(myStopId)) {
    return (
  ...
  // Calculate uncompleted stops before my stop
  ...
  return (
    <div className="bg-surface-container-lowest border border-outline-variant/10 p-4 rounded-xl flex items-center justify-between shadow-sm">
      ...
      <div className="bg-secondary/10 text-secondary w-8 h-8 rounded-full flex items-center justify-center">
